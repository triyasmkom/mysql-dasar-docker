...
--
-- Host: mariadb:3306
-- Generation Time: Oct 16, 2023 at 10:02 AM
...
-- Procedures
--
CREATE DEFINER=`root`@`%` PROCEDURE `GetOneProduct` (IN `prod_code` VARCHAR(100))   BEGIN
    SELECT * FROM products WHERE  productCode = prod_code;
END$$

CREATE DEFINER=`root`@`%` PROCEDURE `GetProduct` ()   BEGIN
    SELECT * FROM products;
END$$

CREATE DEFINER=`root`@`%` PROCEDURE `Transfer` (IN `nasabah1` INT, IN `nasabah2` INT, IN `jumlahTransfer` INT(11), OUT `sisaSaldoNasabah1` INT(11))   BEGIN
...
-- Functions
--
CREATE DEFINER=`root`@`%` FUNCTION `alterCustomerName` (`name` VARCHAR(100)) RETURNS VARCHAR(150) CHARSET latin1 COLLATE latin1_swedish_ci  BEGIN
    RETURN CONCAT('Customer Name is ', name);
END$$

CREATE DEFINER=`root`@`%` FUNCTION `checkCustomerName` (`name1` VARCHAR(100), `name2` VARCHAR(100)) RETURNS VARCHAR(150) CHARSET latin1 COLLATE latin1_swedish_ci  BEGIN
    IF name1 = name2
        THEN
            RETURN 'Nama Sama';
        ELSE
...
CREATE DEFINER=`root`@`%` FUNCTION `customerName` (`name` VARCHAR(100)) RETURNS VARCHAR(100) CHARSET latin1 COLLATE latin1_swedish_ci  BEGIN
    RETURN name;
END$$

CREATE DEFINER=`root`@`%` FUNCTION `hargaRupiah` (`harga_asli` INT(11)) RETURNS INT(11)  BEGIN
    DECLARE hasil INT(11);
    SET hasil = harga_asli * 15000;
    RETURN hasil;
END$$

CREATE DEFINER=`root`@`%` FUNCTION `tambahHarga` (`harga_asli` DECIMAL(6,2)) RETURNS DECIMAL(6,2)  BEGIN
    DECLARE hasil DECIMAL(6,2);
    SET hasil = harga_asli + 2.51;
    RETURN hasil;
END$$

CREATE DEFINER=`root`@`%` FUNCTION `tambahHargaDollar` (`harga_asli` DECIMAL(11,2)) RETURNS DECIMAL(11,2)  BEGIN
    DECLARE hasil DECIMAL(11,2);
    SET hasil = harga_asli + 2.67;
    RETURN hasil;
END$$
...
(500, 'Yamaha', 'Kurniawan', 'Dani', '0274-1111111', 'Jl Sriwijaya 2', NULL, 'Sleman', NULL, NULL, 'D.I. Yogyakarta', NULL, NULL),
(501, 'Honda', 'Putri', 'Santika', '0274-222222', 'Jl Mancanegara', NULL, 'Sleman', NULL, NULL, 'D.I. Yogyakarta', NULL, NULL),
(502, 'Suzuki', 'Pratama', 'Yudha', '0274-33333', 'Jl Kusuma Putra', NULL, 'Sleman', NULL, NULL, 'D.I. Yogyakarta', NULL, NULL),
(503, 'Astra Daihatsu', 'Putra', 'Andika', '0274-4444444', 'Jl Cendrawasih', NULL, 'Bantul', NULL, NULL, 'D.I. Yogyakarta', NULL, NULL),
(504, 'Yamaha', 'Dani', 'Kurniawan', '0274-1111111', 'Jl Sriwijaya 1', 'Jl Sriwijaya 2', 'Sleman', 'D.I. Yogyakarta', '55222', 'Indonesia', 1612, 10000.00);
...
INSERT INTO `nasabah` (`id`, `username`, `balance`, `createdAt`, `updatedAt`) VALUES
(1, 'triyas', 400000, '2023-08-23 06:57:07', '2023-08-23 07:38:23'),
(2, 'hevianto', 2, '2023-08-23 06:57:07', '2023-08-23 07:48:02'),
(3, 'azka', 1000000, '2023-08-23 07:25:53', '2023-08-23 07:25:53'),
(4, 'nufail', 1000000, '2023-08-23 07:25:53', '2023-08-23 07:25:53');
...
INSERT INTO `transaksi` (`id`, `nasabah_id`, `history`, `createAt`, `updatedAt`) VALUES
(1, 2, NULL, '2023-08-23 07:42:15', '2023-08-23 07:42:15'),
(2, 2, NULL, '2023-08-23 07:43:49', '2023-08-23 07:43:49'),
(3, 2, NULL, '2023-08-23 07:44:23', '2023-08-23 07:44:23'),
(4, 2, 'Failed Transfer 100000 from hevianto to triyas', '2023-08-23 07:45:32', '2023-08-23 07:45:32'),
(5, 2, 'Failed Transfer 100000 from hevianto to triyas', '2023-08-23 07:48:25', '2023-08-23 07:48:25');
...
--
ALTER TABLE `transaksi`
  ADD CONSTRAINT `nasabah_transaksi` FOREIGN KEY (`nasabah_id`) REFERENCES `nasabah` (`id`);
COMMIT;
